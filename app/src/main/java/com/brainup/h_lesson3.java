...
public class h_lesson3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h_lesson3);

        ImageView ib = findViewById(R.id.imageView18);
        ib.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setContentView(R.layout.h_quiz3);

                Button btn1=findViewById(R.id.button5);
                Button btn4=findViewById(R.id.button11);
                Button btnc=findViewById(R.id.button12);
                ...
                btnc.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        new AlertDialog.Builder(h_lesson3.this)
                                .setTitle(getText(R.string.corr))
                                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {

                                        Intent intent = new Intent(h_lesson3.this,h_lesson4.class);
